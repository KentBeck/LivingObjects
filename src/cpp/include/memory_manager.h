...
public:
     ...
     */
    MethodContext* allocateMethodContext(size_t size, TaggedValue self, TaggedValue sender, CompiledMethod* compiledMethod);
     ...
     */
    BlockContext* allocateBlockContext(size_t size, TaggedValue self, TaggedValue sender, TaggedValue home);
