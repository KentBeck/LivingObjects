 ...
 */
TaggedValue primitive_exception_mark(TaggedValue receiver,
 ...
 */
TaggedValue primitive_signal(TaggedValue receiver,
                             const std::vector<TaggedValue> &args,
                             Interpreter &interpreter) {
  (void)args;
  (void)interpreter;
  ...
  // In a full implementation, this would create a proper Smalltalk exception
  // object
  ...
  std::string className =
      exceptionClass ? exceptionClass->getName() : "Exception";
  ...
  if (className == "ZeroDivisionError") {
    ...
    ExceptionHandler::throwException(
        std::make_unique<MessageNotUnderstood>("Object", "unknown"));
  } else {
...
void registerExceptionPrimitives() {
  ...
  registry.registerPrimitive(PrimitiveNumbers::EXCEPTION_MARK,
                             ExceptionPrimitives::primitive_exception_mark);
  registry.registerPrimitive(PrimitiveNumbers::EXCEPTION_SIGNAL,
                             ExceptionPrimitives::primitive_signal);
}
