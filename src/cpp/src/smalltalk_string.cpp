...
String::String(const std::string &content, Class *stringClass)
    : Object(ObjectType::OBJECT, sizeof(String), stringClass),
      content_(content) {}
...
std::string String::toString() const { return "'" + content_ + "'"; }

size_t String::hash() const { return std::hash<std::string>{}(content_); }
