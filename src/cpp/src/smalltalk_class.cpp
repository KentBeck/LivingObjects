...
void initializeCoreClasses() {
  ...
  addPrimitiveMethod(core.classClass,
                     "new:", 72); // Class new: size (for Array new:, etc.)
  ...
  addPrimitiveMethod(core.integerClass, "+",
                     PrimitiveNumbers::SMALL_INT_ADD); // Integer +
  addPrimitiveMethod(core.integerClass, "-",
                     PrimitiveNumbers::SMALL_INT_SUB); // Integer -
  addPrimitiveMethod(core.integerClass, "*",
                     PrimitiveNumbers::SMALL_INT_MUL); // Integer *
  addPrimitiveMethod(core.integerClass, "/",
                     PrimitiveNumbers::SMALL_INT_DIV); // Integer /
  addPrimitiveMethod(core.integerClass, "<",
                     PrimitiveNumbers::SMALL_INT_LT); // Integer <
  addPrimitiveMethod(core.integerClass, ">",
                     PrimitiveNumbers::SMALL_INT_GT); // Integer >
  addPrimitiveMethod(core.integerClass, "=",
                     PrimitiveNumbers::SMALL_INT_EQ); // Integer =
  addPrimitiveMethod(core.integerClass,
                     "~=", PrimitiveNumbers::SMALL_INT_NE); // Integer ~=
  addPrimitiveMethod(core.integerClass,
                     "<=", PrimitiveNumbers::SMALL_INT_LE); // Integer <=
  addPrimitiveMethod(core.integerClass,
                     ">=", PrimitiveNumbers::SMALL_INT_GE); // Integer >=

  // Add primitive methods to String class
  addPrimitiveMethod(core.stringClass,
                     "at:", PrimitiveNumbers::STRING_AT); // String at:
  addPrimitiveMethod(core.stringClass, ",",
                     PrimitiveNumbers::STRING_CONCAT); // String ,
  addPrimitiveMethod(core.stringClass, "size",
                     PrimitiveNumbers::STRING_SIZE); // String size
  addPrimitiveMethod(core.stringClass, "asSymbol",
                     PrimitiveNumbers::STRING_AS_SYMBOL); // String asSymbol
  ...
  addPrimitiveMethod(systemLoaderClass,
                     "start:", PrimitiveNumbers::SYSTEM_LOADER_START);
  ...
  addPrimitiveMethod(compilerClass,
                     "compile:in:", PrimitiveNumbers::COMPILER_COMPILE_IN);
}
