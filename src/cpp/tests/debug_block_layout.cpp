...
void printObjectLayout(const std::string& label, Object* obj) {
    ...
    std::cout << "  Class: " << (obj->getClass() ? obj->getClass()->getName() : "nullptr") << std::endl;
...
void testBlockContextCreation() {
    ...
    // BlockContext constructor requires: contextSize, methodRef, receiver, senderContext, homeContext
    auto* blockContext = new BlockContext(256, 0, nullptr, nullptr, parentContext);
...
void testBlockMemoryLayout() {
    ...
    std::cout << "  sizeof(MethodContext): " << sizeof(MethodContext) << " bytes" << std::endl;
    std::cout << "  sizeof(BlockContext): " << sizeof(BlockContext) << " bytes" << std::endl;
    std::cout << "  sizeof(CompiledMethod): " << sizeof(CompiledMethod) << " bytes" << std::endl;
...
void testBlockContextHierarchy() {
    ...
    std::cout << "  Can cast to BlockContext*: " << (dynamic_cast<BlockContext*>(objectPtr) != nullptr) << std::endl;
