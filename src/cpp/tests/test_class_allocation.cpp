...
void testBasicClassAllocation() {
    ...
    std::cout << "    Instance size: " << objectClass->getInstanceSize() << std::endl;
    std::cout << "    Format: " << static_cast<int>(objectClass->getFormat()) << std::endl;
}
...
void testCustomClassWithInstanceVariables() {
    ...
    std::cout << "  Point class created with " << pointClass->getInstanceSize() << " instance variables" << std::endl;
...
void testArrayClassAllocation() {
    ...
    std::cout << "    Indexable format: " << arrayClass->isIndexable() << std::endl;
    std::cout << "    Is pointer format: " << arrayClass->isPointerFormat() << std::endl;
}
...
void testByteArrayClassAllocation() {
    ...
    Object* byteArray = memoryManager.allocateByteIndexableInstance(byteArrayClass, 100);
    ...
    std::cout << "    Byte indexable: " << byteArrayClass->isByteIndexable() << std::endl;
    std::cout << "    Is indexable: " << byteArrayClass->isIndexable() << std::endl;
}
...
void testStringClassAllocation() {
    ...
    std::cout << "    Format: " << static_cast<int>(stringClass->getFormat()) << std::endl;
}
...
void testClassHierarchyWithInstanceSizes() {
    ...
    std::cout << "  Object instance size: " << objectClass->getInstanceSize() << std::endl;
    std::cout << "  Shape instance size: " << shapeClass->getInstanceSize() << std::endl;
    std::cout << "  Rectangle instance size: " << rectangleClass->getInstanceSize() << std::endl;
...
void testErrorConditions() {
    ...
    try {
        ...
        std::cout << "  ✓ Null class allocation properly throws: " << e.what() << std::endl;
    }
    ...
    try {
        ...
        std::cout << "  ✓ Non-indexable class indexable allocation properly throws: " << e.what() << std::endl;
    }
    ...
    try {
        ...
        std::cout << "  ✓ Non-byte-indexable class byte allocation properly throws: " << e.what() << std::endl;
    }
}
